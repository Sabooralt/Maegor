      ...
      >
        <div className="mx-auto max-w-4xl p-4">
          ...
          <input
            ...
            className="relative z-10 mt-4 w-full rounded-lg border border-neutral-800 bg-neutral-950 text-neutral-500 placeholder:text-neutral-700 focus:ring-2 focus:ring-teal-500"
          />
        </div>
      </motion.div>
    </AnimatePresence>
